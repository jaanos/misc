...
* @see <a href="http://nehe.gamedev.net/data/lessons/lesson.asp?lesson=13">NeHe's OpenGL Lesson #13</a>
*/
class GLFont {
	/**
	* White foreground.
	...
	*/
	GLFont(String fontName) {                          // Build Our Bitmap Font
        ...
        if(msg != null) {
            ...
            for(int i=0;i<msg.length();i++) {
                if (msg.charAt(i) == '\n') {
					GL11.glPopMatrix();
					GL11.glPushMatrix();
					GL11.glTranslatef(0.0f, y-=0.1f, 0.0f);
				} else {
