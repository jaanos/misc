...
divide.world <- function(c1, c2, xlim=c(-180, 180), ylim=c(-90, 90), add = FALSE,
                         col = "red", col1 = "blue", col2 = "green", cex = 1) {
  if (!add) {
    plot(svet, xlim=xlim, ylim=ylim)
  }
  curve(bisector.th(capitals[c1,"Longitude"], capitals[c1,"Latitude"],
